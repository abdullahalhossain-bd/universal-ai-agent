...
def test_ssrf_literal_hosts_are_blocked(url, monkeypatch):
    # The shared conftest enables the dev-only local-host override for
    # datasource tests. Clear it here so this test exercises the default
    # production posture (same isolation as test_ssrf_guard.py and
