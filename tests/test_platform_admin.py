...
def test_production_settings_allow_wildcard_cors_for_embeddable_widget():
    configured = Settings(
        environment="production",
    ...
    assert configured.cors_allow_origins == "*"


def test_production_settings_reject_empty_cors():
