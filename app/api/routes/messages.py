...
# Merchant conversation endpoints MUST use the dashboard JWT. Do not switch
# these to get_current_store(), because that dependency also accepts the
# public pk_live widget credential.
@router.get("/conversations")
def list_conversations(
    auth: tuple[User, Store] = Depends(get_current_user_and_store),
