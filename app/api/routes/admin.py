...
def system_health(admin: PlatformAdmin = Depends(get_current_admin)):
    ...
    try:
        ...
        except RuntimeError: asyncio.run(redis_client.ping())
        else: checks["redis"] = "async-check-required"
