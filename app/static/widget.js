...
(function () {
  ...
  css.textContent =
    ...
    ".bubble{position:relative;width:58px;height:58px;border:0;border-radius:20px;background:linear-gradient(135deg,#6366f1,#8b5cf6,#06b6d4);color:#fff;box-shadow:0 12px 34px rgba(79,70,229,.38);cursor:pointer;display:grid;place-items:center;transition:transform .18s ease,box-shadow .18s ease}.bubble:hover{transform:translateY(-2px);box-shadow:0 16px 38px rgba(79,70,229,.48)}.bubble svg{width:26px;height:26px;fill:none;stroke:currentColor;stroke-width:1.8}.badge{position:absolute;right:-4px;top:-4px;min-width:19px;height:19px;border-radius:999px;background:#ef4444;color:#fff;font:800 10px Inter;display:none;place-items:center;border:2px solid #090d16}.badge.show{display:grid}" +
    ...
    ".welcome{align-self:flex-start;width:100%;display:flex;gap:8px}.mini-avatar{width:28px;height:28px;min-width:28px;margin-top:2px;border-radius:10px;background:rgba(99,102,241,.18);border:1px solid rgba(165,180,252,.28);display:grid;place-items:center}.mini-avatar svg{width:14px;height:14px;stroke:#a5b4fc;fill:none;stroke-width:2}.welcome-body{flex:1;min-width:0}.welcome-card{padding:12px 13px;border-radius:16px;border-top-left-radius:5px;background:linear-gradient(135deg,rgba(26,34,53,.76),rgba(15,23,42,.88));border:1px solid rgba(255,255,255,.1)}.welcome-bn{font-size:12px;line-height:1.65;color:#f1f5f9;font-weight:550}.welcome-en{font-size:10.5px;color:#cbd5e1;line-height:1.55;margin-top:8px}.divider{height:1px;background:rgba(255,255,255,.1);margin:9px 0}.example{color:#a5b4fc;font-weight:700}.discover{margin-top:8px;display:grid;gap:7px}.discover-card{padding:9px 10px;border-radius:15px;border:1px solid rgba(255,255,255,.1);background:rgba(255,255,255,.035);display:flex;align-items:center;justify-content:space-between;gap:8px}.discover-card.support{background:rgba(16,185,129,.09);border-color:rgba(52,211,153,.2)}.discover-main{display:flex;align-items:center;gap:8px;min-width:0}.discover-icon{width:28px;height:28px;border-radius:10px;display:grid;place-items:center;background:rgba(249,115,22,.12);font-size:13px;flex:none}.support .discover-icon{background:rgba(16,185,129,.12)}.discover-title{font-size:10.5px;font-weight:750;color:#fff;overflow-wrap:anywhere}.discover-sub{font-size:9.5px;color:#94a3b8;margin-top:1px}.support .discover-title{color:#d1fae5}.support-action{border:1px solid rgba(52,211,153,.25);background:rgba(16,185,129,.16);color:#6ee7b7;border-radius:10px;padding:7px 9px;font-size:9.5px;font-weight:700;white-space:nowrap;cursor:pointer;flex:none}" +
  ...
  wrap.innerHTML = '<button class="bubble" type="button" aria-label="চ্যাট খুলুন" aria-expanded="false"><svg viewBox="0 0 24 24"><path d="M20 11.5a7.5 7.5 0 0 1-7.5 7.5 8.4 8.4 0 0 1-3.6-.8L4 20l1.2-4A7.3 7.3 0 0 1 5 11.5 7.5 7.5 0 0 1 12.5 4 7.5 7.5 0 0 1 20 11.5Z"/><path d="M9 12h.01M12.5 12h.01M16 12h.01"/></svg><span class="badge"></span></button>' +
    ...
    '<div class="modebar"><div class="mode-switch"><button class="mode-btn ai active" type="button">✦ <span>AI Assistant</span><small>Active</small></button><button class="mode-btn live" type="button">▢ <span>লাইভ সাপোর্ট</span><small>(Live)</small></button></div><div class="mode-note"><span class="mode-label">● Mode: AI Shopper</span><span class="live-note">Merchant support mode</span><span>প্রয়োজনে সরাসরি merchant-এর সাথে কথা বলুন</span></div></div>' +
    '<div class="messages" role="log" aria-live="polite"></div>' +
    '<div class="quickbar"><button class="quick image-quick" type="button">📷 ছবি পাঠান</button><button class="quick">MacBook Pro pricing</button><button class="quick">Under ৳50,000</button><button class="quick support">● 💬 লাইভ সাপোর্ট</button></div>' +
  ...
  var aiBtn = wrap.querySelector(".mode-btn.ai"), liveBtn = wrap.querySelector(".mode-btn.live"), quickSupport = wrap.querySelector(".quick.support");
  ...
  function showWelcome() {
    ...
    el.innerHTML = '<div class="mini-avatar"><svg viewBox="0 0 24 24"><path d="M12 2l3.1 6.3L22 9.3l-5 4.9 1.2 6.8-6.2-3.2L12 18l-6.2 3.2L7 14.2 2 9.3l6.9-1L12 2Z"/></svg></div><div class="welcome-body"><div class="welcome-card"><div class="welcome-bn"></div><div class="divider"></div><div class="welcome-en">Hello! I\'m your AI shopping companion. Ask about prices, specs, stock, or product links.</div></div><div class="discover"><div class="discover-card"><div class="discover-main"><div class="discover-icon">🔥</div><div><div class="discover-title">Smart product search</div><div class="discover-sub">Find products by name, category, price or stock</div></div></div><span>›</span></div><div class="discover-card support"><div class="discover-main"><div class="discover-icon">♙</div><div><div class="discover-title">মার্চেন্টের সাহায্য দরকার?</div><div class="discover-sub">Need human help? Connect directly with merchant</div></div></div><button class="support-action" type="button">যুক্ত হোন →</button></div></div></div>';
