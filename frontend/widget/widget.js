 ...
 *
 * This file is a reference copy of the canonical, served widget at
 * `app/static/widget.js` (mounted at GET /widget.js by
 * app/widget/router.py). Keep the two in sync — this copy exists so
 * the embeddable widget's source is easy to find alongside the rest
 * of `frontend/`, not because it's loaded by the running app.
 *
